...
echo "started filtering clusters based on source" >> $LOG
		...
		mv sources.tsv clinical_clusters/ 
...
#extracting genomes from clinical sources
...
# Counting genomes per cluster and filter clusters with at least minimum number of clinical genomes
